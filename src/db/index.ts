...
export async function initializeDatabaseSchema() {
  ...
  try {
    ...
    // Ensure all table columns exist even if tables were created previously
    const alterQueries = [
      ...
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS cr_number TEXT`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS tax_rate_pct NUMERIC DEFAULT 15`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS currency_symbol TEXT DEFAULT 'ج.س'`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS currency_code TEXT DEFAULT 'SDG'`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS address_ar TEXT`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS address_en TEXT`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS subscription_plan TEXT DEFAULT 'PRO_SAAS'`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS active_branches_count INT DEFAULT 1`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS joined_date TEXT`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS primary_color_hex TEXT`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS receipt_header_ar TEXT`,
      `ALTER TABLE tenants ADD COLUMN IF NOT EXISTS receipt_footer_ar TEXT`,
      ...
      `ALTER TABLE customers ADD COLUMN IF NOT EXISTS preferred_fabric TEXT`,
      ...
      `ALTER TABLE customers ADD COLUMN IF NOT EXISTS lead_score INT DEFAULT 50`,
      `ALTER TABLE customers ADD COLUMN IF NOT EXISTS lead_intent TEXT DEFAULT 'WARM'`,
      `ALTER TABLE customers ADD COLUMN IF NOT EXISTS conversion_probability TEXT`,
      `ALTER TABLE customers ADD COLUMN IF NOT EXISTS last_order_date TEXT`,
      `ALTER TABLE customers ADD COLUMN IF NOT EXISTS email_opens INT DEFAULT 0`,
      `ALTER TABLE customers ADD COLUMN IF NOT EXISTS email_clicks INT DEFAULT 0`,
      `ALTER TABLE customers ADD COLUMN IF NOT EXISTS measurement_taken BOOLEAN DEFAULT FALSE`,
      `ALTER TABLE customers ADD COLUMN IF NOT EXISTS tags_json TEXT`,
      ...
      `ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS customer_id TEXT`,
      `ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS customer_name TEXT`,
      `ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS type TEXT`,
      `ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS subject TEXT`,
      `ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS content TEXT`,
      `ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS sent_at TEXT`,
      `ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS status TEXT`,
      `ALTER TABLE email_logs ADD COLUMN IF NOT EXISTS lead_score_impact INT DEFAULT 0`,

      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS tenant_id TEXT`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS customer_id TEXT`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS customer_name TEXT`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS garment_type TEXT`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS chest NUMERIC`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS waist NUMERIC`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS shoulder NUMERIC`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS sleeve_length NUMERIC`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS collar_size NUMERIC`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS overall_length NUMERIC`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS armhole NUMERIC`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS wrist NUMERIC`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS notes TEXT`,
      `ALTER TABLE measurements ADD COLUMN IF NOT EXISTS updated_at TEXT`,
      ...
      `ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS outstanding_payable NUMERIC DEFAULT 0`,

      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS tenant_id TEXT`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS roll_code TEXT`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS supplier_id TEXT`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS supplier_name TEXT`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS fabric_type TEXT`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS composition TEXT`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS color TEXT`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS pattern_code TEXT`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS width NUMERIC`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS total_meters NUMERIC`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS remaining_meters NUMERIC`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS cost_per_meter NUMERIC`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS price_per_meter NUMERIC`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS branch_id TEXT`,
      `ALTER TABLE fabric_rolls ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'AVAILABLE'`,
      ...
      `ALTER TABLE products ADD COLUMN IF NOT EXISTS stock_json TEXT`,
      `ALTER TABLE products ADD COLUMN IF NOT EXISTS reorder_point INT DEFAULT 10`,
      ...
      `ALTER TABLE orders ADD COLUMN IF NOT EXISTS garment_style TEXT`,
      `ALTER TABLE orders ADD COLUMN IF NOT EXISTS measurement_profile_id TEXT`,
      `ALTER TABLE orders ADD COLUMN IF NOT EXISTS fabric_roll_id TEXT`,
      `ALTER TABLE orders ADD COLUMN IF NOT EXISTS fabric_name TEXT`,
      `ALTER TABLE orders ADD COLUMN IF NOT EXISTS meters_used NUMERIC`,
      `ALTER TABLE orders ADD COLUMN IF NOT EXISTS assigned_tailor_id TEXT`,
      `ALTER TABLE orders ADD COLUMN IF NOT EXISTS assigned_tailor_name TEXT`,
      ...
      `ALTER TABLE orders ADD COLUMN IF NOT EXISTS deposit_paid NUMERIC DEFAULT 0`,
      `ALTER TABLE orders ADD COLUMN IF NOT EXISTS balance_due NUMERIC DEFAULT 0`,
      `ALTER TABLE orders ADD COLUMN IF NOT EXISTS due_date TEXT`,
      ...
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS tenant_id TEXT`,
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS order_id TEXT`,
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS order_number TEXT`,
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS customer_name TEXT`,
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS garment_name TEXT`,
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS current_stage TEXT`,
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS assigned_employee_id TEXT`,
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS assigned_employee_name TEXT`,
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS due_date TEXT`,
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS days_in_stage INT DEFAULT 0`,
      `ALTER TABLE production_tasks ADD COLUMN IF NOT EXISTS notes TEXT`,
      ...
      `ALTER TABLE invoices ADD COLUMN IF NOT EXISTS tax NUMERIC`,
      ...
      `ALTER TABLE payments ADD COLUMN IF NOT EXISTS related_entity TEXT`,
      `ALTER TABLE payments ADD COLUMN IF NOT EXISTS related_id TEXT`,
      ...
      `ALTER TABLE purchase_orders ADD COLUMN IF NOT EXISTS items_json TEXT`,
      ...
      `ALTER TABLE purchase_orders ADD COLUMN IF NOT EXISTS created_at TEXT`,
      ...
      `ALTER TABLE employees ADD COLUMN IF NOT EXISTS attendance_rate NUMERIC`,
      `ALTER TABLE employees ADD COLUMN IF NOT EXISTS monthly_commission NUMERIC`,
      `ALTER TABLE employees ADD COLUMN IF NOT EXISTS assigned_tasks_count INT DEFAULT 0`,
      ...
      `ALTER TABLE user_tasks ADD COLUMN IF NOT EXISTS tenant_id TEXT`,
      `ALTER TABLE user_tasks ADD COLUMN IF NOT EXISTS title_ar TEXT`,
      `ALTER TABLE user_tasks ADD COLUMN IF NOT EXISTS title_en TEXT`,
      `ALTER TABLE user_tasks ADD COLUMN IF NOT EXISTS description TEXT`,
      `ALTER TABLE user_tasks ADD COLUMN IF NOT EXISTS priority TEXT`,
      `ALTER TABLE user_tasks ADD COLUMN IF NOT EXISTS due_date TEXT`,
      `ALTER TABLE user_tasks ADD COLUMN IF NOT EXISTS action_required BOOLEAN DEFAULT TRUE`,
      `ALTER TABLE user_tasks ADD COLUMN IF NOT EXISTS related_module TEXT`,
      ...
      `ALTER TABLE expenses ADD COLUMN IF NOT EXISTS description_ar TEXT`,
      `ALTER TABLE expenses ADD COLUMN IF NOT EXISTS description_en TEXT`,
    ...
    for (const altQuery of alterQueries) {
      try {
        await db.query(altQuery);
      } catch (colErr) {
        // Ignore duplicate column errors or minor warnings
      }
    }
